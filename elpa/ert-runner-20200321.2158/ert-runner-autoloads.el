...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ert-compat" '("ert-" "should")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ert-runner" '("ert-runner")))
